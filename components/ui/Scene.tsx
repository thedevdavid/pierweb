 ...
 */
const Terrain = React.forwardRef((props: any, ref) => {
  const { z } = props;
 ...
 */
const Landscape = () => {
  const terrain1Ref = React.useRef<any>();
  const terrain2Ref = React.useRef<any>();
 ...
 */
const Light = () => {
  const spotlight1Ref = React.useRef<any>();
  const spotlight2Ref = React.useRef<any>();
